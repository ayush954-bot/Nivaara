...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/nivaararealty/",
    icon: (
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/nivaara-realty-solutions/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
  ...
  {
    name: "YouTube",
    href: "https://youtube.com/@nivaararealtysolutions?si=xdoJmVkNRZxDIjZF",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/share/1D823E5YDE/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
  ...
  },
  {
    ...
    href: "https://share.google/OCeZ6UJXQook8qyH2",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            {/* Social Media Icons */}
            <div>
              <p className="text-sm font-semibold mb-3 text-background/90">Follow Us</p>
