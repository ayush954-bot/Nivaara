  ...
  if (variant === "fixed") {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 group animate-bounce-slow"
