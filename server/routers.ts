  ...
  admin: router({
    ...
    projects: router({
      ...
      list: publicProcedure
        ...
        .query(async ({ input }) => {
          return await db.listProjects(input || {});
        }),
      ...
      create: publicProcedure
        .input(
          z.object({
            ...
            minPrice: z.number().optional(),
            maxPrice: z.number().optional(),
            status: z.enum(["Upcoming", "Under Construction", "Ready to Move", "Completed"]),
      ...
      update: publicProcedure
        .input(
          z.object({
            ...
            minPrice: z.number().optional(),
            maxPrice: z.number().optional(),
            status: z.enum(["Upcoming", "Under Construction", "Ready to Move", "Completed"]).optional(),
            reraNumber: z.string().optional(),
            launchDate: z.string().optional(),
            possessionDate: z.string().optional(),
            totalUnits: z.number().optional(),
      ...
      images: router({
        list: publicProcedure
          ...
          .query(async ({ input }) => {
            return await db.listProjectImages(input.projectId);
          }),
        ...
        add: publicProcedure
          ...
          .mutation(async ({ input, ctx }) => {
            ...
            return await db.addProjectImage(input as any);
          }),
        ...
        setCover: publicProcedure
          .input(z.object({ projectId: z.number(), imageId: z.number() }))
          .mutation(async ({ input, ctx }) => {
            const isOAuthAdmin = ctx.user?.role === "admin";
            const isStaffPropertyManager = ctx.staff?.role === "property_manager";
            ...
            return await db.setProjectCoverImage(input.projectId, input.imageId);
          }),
      }),
      ...
      videos: router({
        list: publicProcedure
          .input(z.object({ projectId: z.number() }))
          .query(async ({ input }) => {
            return await db.listProjectVideos(input.projectId);
          }),
        ...
        add: publicProcedure
          .input(
            z.object({
              projectId: z.number(),
              videoUrl: z.string(),
              videoType: z.enum(["youtube", "vimeo", "virtual_tour", "other"]).optional(),
              displayOrder: z.number().optional(),
            })
          )
          .mutation(async ({ input, ctx }) => {
            ...
            return await db.addProjectVideo(input as any);
          }),
      ...
      amenities: router({
        list: publicProcedure
          .input(z.object({ projectId: z.number() }))
          .query(async ({ input }) => {
            return await db.listProjectAmenities(input.projectId);
          }),
        ...
        add: publicProcedure
          ...
          .mutation(async ({ input, ctx }) => {
            ...
            return await db.addProjectAmenity(input as any);
          }),
      ...
      floorPlans: router({
        list: publicProcedure
          .input(z.object({ projectId: z.number() }))
          .query(async ({ input }) => {
            return await db.listProjectFloorPlans(input.projectId);
          }),
        ...
        add: publicProcedure
          ...
          .mutation(async ({ input, ctx }) => {
            ...
            return await db.addProjectFloorPlan(input as any);
          }),
    ...
    builders: router({
      list: publicProcedure.query(async () => {
        return await db.listBuilders();
      }),
      
      getById: publicProcedure
        .input(z.object({ id: z.number() }))
        .query(async ({ input }) => {
          return await db.getBuilderById(input.id);
        }),
      ...
      create: publicProcedure
        .input(
          z.object({
            ...
            ongoingProjects: z.number().optional(),
        ...
        .mutation(async ({ input, ctx }) => {
          ...
          return await db.createBuilder(input as any);
        }),
      ...
      update: publicProcedure
        ...
        .mutation(async ({ input, ctx }) => {
          ...
          const { id, ...data } = input;
          return await db.updateBuilder(id, data as any);
        }),
      ...
      delete: publicProcedure
        ...
        .mutation(async ({ input, ctx }) => {
          ...
          return await db.deleteBuilder(input.id);
        }),
    }),
